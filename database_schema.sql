...
CREATE TABLE `tasks` (
  ...
  `repetition_type` enum('daily','weekly','monthly','yearly') DEFAULT NULL COMMENT 'Repetition type - used in /api/v1/tasks/*',
  `repetition_interval` int DEFAULT NULL COMMENT 'Repetition interval - used in /api/v1/tasks/*',
  `repetition_end_date` date DEFAULT NULL COMMENT 'Repetition end date - used in /api/v1/tasks/*',
